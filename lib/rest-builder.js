 ...
 * @returns {RequestBuilder}
 */
RequestBuilder.compile = RequestBuilder.fromJSON = function (req, requestFunc, config) {
...
RequestBuilder.prototype.invoke = function (parameters, cb) {
  ...
  var secure = require('url').parse(req.uri).protocol === 'https:';
